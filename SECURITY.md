...
Replace this section with the supported versions for `proofdock`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `proofdock` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in proofdock.
